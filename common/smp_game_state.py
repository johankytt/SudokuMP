...
class SMPGameState():
	...
	def __init__(self, gid, max_players, generate_puzzle=True):
		...
		'''
		self._gid = gid  # Unique game id generated by the server
		self._max_player_count = max_players  # Max number of players.
		self._pinfo = []  # A list of SMPPlayerInfo objects
		self._pinfo_lock = threading.Lock()
		if generate_puzzle:
			self._puzzle = SMPPuzzle.get_new_puzzle()
		else:
			self._puzzle = None  # An instance of SMPPuzzle
